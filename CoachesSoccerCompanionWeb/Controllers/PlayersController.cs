...
namespace CoachesSoccerCompanionWeb.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DateOfBirth,Id,FirstName,LastName")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("DateOfBirth,Id,FirstName,LastName")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
